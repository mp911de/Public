...
public class Team {
    ...
    /**
     * @param regularSprintLength
     *            the regularSprintLength to set
     */
    ...
    /**
     * @param regularSprintStart
     *            the regularSprintStart to set
     */
    ...
    public String toString() {
        ...
        return getClass().getSimpleName() + " [id=" + id + ", regularSprintLength=" + regularSprintLength
                + ", regularSprintStart=" + regularSprintStart + ", teamSize=" + teamSize + ", name=" + name + "]";
    }
